...
public class cal extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//문자값을 문자 메소드로 전달 -> 최종 결과값을 문자로 받음 (받아오는 클래스가 String이니 String으로 받고 int일땐 int로 받자)
		...
		//ctrl + shift + H = 라이브러리 확인하기
		//RequestDispatcher : View 실제 파일을 로드하여 해당 Cotroller에서 보여지도록 하는 클래스
